...
class CMSTest < Minitest::Test
  ...
  def test_editing_document
    create_document "changes.txt"
    get "/edit/changes.txt", {}, admin_session
  ...
  def test_create_unsupported_filetype
    post "/create", {filename: "test.pxeg"}, admin_session
    assert_equal 422, last_response.status

    assert_includes last_response.body, "Filetype not supported."
  end
